...
- **July 25, 2025 - Social Media Image Generator Implementation Complete**: Completely replaced problematic HTML/PDF catalogue system with modern social media image generator optimized for Facebook, Instagram, TikTok advertising. Implemented comprehensive SocialMediaGenerator component using html2canvas for client-side image generation with multiple format options (Square Post 1080x1080, Instagram Story 1080x1920, Facebook Cover 1200x630, TikTok Video 1080x1920). Features property selection interface with visual thumbnails, dynamic social media post layouts with purple/orange branding, property images with gradient overlays, formatted pricing in ZAR, contact information overlay, and automatic PNG download functionality. Added navigation routes (/admin/social-media) and admin sidebar integration with Image icon. Generator creates professional property advertisements ready for immediate social media posting with proper dimensions and engaging visual design. Enhanced catalogue generator to include "Social Media Images" card directing users to new social media generator for better advertising formats. System eliminates HTML/PDF complications while providing superior social media marketing tools for property promotion.
