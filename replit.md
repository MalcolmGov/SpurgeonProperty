...
- **June 29, 2025 - Commercial Property Bedrooms/Bathrooms Conditional Display**: Implemented conditional display logic across all property forms and cards to hide bedrooms/bathrooms fields for commercial and land properties. Updated basic-property-form, minimal-property-form, working-property-form, property-form components and both property card display sections. Commercial properties (warehouses, office spaces) and land listings now properly hide irrelevant bedroom/bathroom information while maintaining area display. Floor area field made optional instead of mandatory for flexible property entry.
