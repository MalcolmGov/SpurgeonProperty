...
import { Home, BarChart3, Building, Users, UserCheck, Settings, Menu, X, Monitor, Share2, BookOpen, Image } from "lucide-react";
...
export default function AdminSidebar() {
  ...
  const navigation = [
    ...
    { name: "Social Media", href: "/admin/social-media", icon: Image },
    // Temporarily hidden
